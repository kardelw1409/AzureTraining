...
using HttpService = BlazorAdmin.Services.HttpService;
...
namespace Microsoft.eShopWeb.Web
{
    public class Startup
    {
        ...
        public void ConfigureProductionServices(IServiceCollection services)
        {
            ...
            if (!string.IsNullOrEmpty(baseUrlConfig.VaultUri))
            {
                var provider = services.BuildServiceProvider();
                var secretClient = provider.GetRequiredService<SecretClient>();

                catalogConnection = secretClient.GetSecret("CatalogConnection").Value.Value;
                identityConnection = secretClient.GetSecret("IdentityConnection").Value.Value;
            }
            else
            {
                catalogConnection = Configuration.GetConnectionString("CatalogConnection");
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Configuration.Bind(ServiceBusOptions.CONFIG_NAME, serviceBusOptions);
            services.AddScoped<BaseUrlConfiguration>(sp => baseUrlConfig);
            ...
            services.AddAzureServices(baseUrlConfig, serviceBusOptions);
